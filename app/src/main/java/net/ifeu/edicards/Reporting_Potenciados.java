...
public class Reporting_Potenciados extends Activity {
    ...
    private void fillPotenciados()
    {
		...
		titleLabel.setText("ARTÍCULOS POTENCIADOS");
		...
		columnHeaderLayout.setBackgroundColor(Color.parseColor("#388E3C"));
    	...
    	for (Potenciado potenciado : reporting.Potenciados.values())
    	{
        	...
        	LabelColor unidades = new LabelColor(this,Color.parseColor("#4CAF50"), true, Gravity.RIGHT);
        	unidades.setRawInputType(InputType.TYPE_CLASS_NUMBER);
        	unidades.setText(potenciado.unidades + " uds.");

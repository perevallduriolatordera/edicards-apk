...
import net.ifeu.library.Imaging.BMPFile;
...
public class BitmapConvertorAsync{
	...
	public BitmapConvertorAsync(Context context) {
 ...
 */
    ...
    public String convertBitmap(Bitmap inputBitmap, String fileName, int width, int height){

...
public class MessageBox {
	...
	public void Show(String title, String text, Context context, MessageBoxType type)
	{
		...
		case Error:
			{
				alertDialog.setIcon(R.drawable.icerror);
				break;
			}
		case Information:
			{
	...
	public String InputBox2(String title, String text, Context context, Object fragment) {
		...
		AlertDialog.Builder alertDialog = new AlertDialog.Builder((Context) fragment);
		alertDialog.setTitle(title);
		alertDialog.setMessage(text);
